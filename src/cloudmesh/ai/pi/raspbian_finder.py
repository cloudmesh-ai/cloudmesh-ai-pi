...
class RaspbianFinder(USBFinderBase):
    ...
    def get_device_info(self, disk_id: str) -> Dict[str, Any]:
        ...
        try:
            # Basic info and mountpoint
            output = subprocess.check_output(["lsblk", "-dno", "MODEL,SIZE,TRAN,MOUNTPOINT", disk_id], text=True)
            ...
            if len(parts) >= 2: 
                ...
                if match:
                    ...
                    info["size"] = f"{info['size_bytes'] // (1024**3)} GB"
